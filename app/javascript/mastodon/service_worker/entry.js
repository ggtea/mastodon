...
function fetchRoot() {
  return fetch('/mstdn/', { credentials: 'include', redirect: 'manual' });
}
...
self.addEventListener('fetch', function(event) {
  ...
  } /* else if (storageFreeable && (ATTACHMENT_HOST ? url.host === ATTACHMENT_HOST : (url.pathname.startsWith('/system/') || url.pathname.startsWith('/mstdn/system/')))) {
